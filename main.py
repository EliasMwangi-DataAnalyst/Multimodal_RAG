...
from custom_types import RAGChunksAndSrc, RAGSearchResult, RAGUpsertResult, RAQQueryResult
...
@inngest_client.create_function(
    ...
    trigger=inngest.TriggerEvent(event="rag/ingest_pdf"), #event to run the ingest function
